...
static LispObject *builtin_terminal_color_level(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
static LispObject *builtin_terminal_supports_truecolor(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
static LispObject *builtin_terminal_supports_256color(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
static LispObject *builtin_terminal_supports_unicode(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
static LispObject *builtin_terminal_encoding(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
static LispObject *builtin_terminal_caps_describe(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
/* Builtin: terminal-best-fg-color - Returns optimal escape sequence for RGB color */
static LispObject *builtin_terminal_best_fg_color(LispObject *args, Environment *env) {
    (void)env;

    if (args == NIL) {
        return lisp_make_error("terminal-best-fg-color requires 3 arguments (r g b)");
    }
    ...
    if (r_obj->type != LISP_INTEGER || g_obj->type != LISP_INTEGER || b_obj->type != LISP_INTEGER) {
        return lisp_make_error("terminal-best-fg-color: arguments must be integers");
    }
...
/* Builtin: terminal-best-bg-color - Returns optimal escape sequence for RGB background */
static LispObject *builtin_terminal_best_bg_color(LispObject *args, Environment *env) {
    (void)env;

    if (args == NIL) {
        return lisp_make_error("terminal-best-bg-color requires 3 arguments (r g b)");
    }
    ...
    if (r_obj->type != LISP_INTEGER || g_obj->type != LISP_INTEGER || b_obj->type != LISP_INTEGER) {
        return lisp_make_error("terminal-best-bg-color: arguments must be integers");
    }
...
static LispObject *builtin_terminal_reset_color(LispObject *args, Environment *env) {
    (void)env;
    (void)args;
...
int lisp_x_init(void) {
    ...
    /* Register builtins */
    env_define(lisp_env, "strip-ansi", lisp_make_builtin(builtin_strip_ansi, "strip-ansi"));
    env_define(lisp_env, "terminal-echo", lisp_make_builtin(builtin_terminal_echo, "terminal-echo"));
    env_define(lisp_env, "telnet-send", lisp_make_builtin(builtin_telnet_send, "telnet-send"));

    /* Terminal capability builtins */
    env_define(lisp_env, "terminal-color-level",
               lisp_make_builtin(builtin_terminal_color_level, "terminal-color-level"));
    env_define(lisp_env, "terminal-supports-truecolor?",
               lisp_make_builtin(builtin_terminal_supports_truecolor, "terminal-supports-truecolor?"));
    env_define(lisp_env, "terminal-supports-256color?",
               lisp_make_builtin(builtin_terminal_supports_256color, "terminal-supports-256color?"));
    env_define(lisp_env, "terminal-supports-unicode?",
               lisp_make_builtin(builtin_terminal_supports_unicode, "terminal-supports-unicode?"));
    ...
    env_define(lisp_env, "terminal-caps-describe",
               lisp_make_builtin(builtin_terminal_caps_describe, "terminal-caps-describe"));
    env_define(lisp_env, "terminal-best-fg-color",
               lisp_make_builtin(builtin_terminal_best_fg_color, "terminal-best-fg-color"));
    env_define(lisp_env, "terminal-best-bg-color",
               lisp_make_builtin(builtin_terminal_best_bg_color, "terminal-best-bg-color"));
    env_define(lisp_env, "terminal-reset-color",
    ...
    LispObject *user_hook = lisp_eval_string("(lambda (text cursor) text)", lisp_env);
...
void lisp_x_load_init_post(void) {
    load_lisp_system_file("init-post.lisp");
}
